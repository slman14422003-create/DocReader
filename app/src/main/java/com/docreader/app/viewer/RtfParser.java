 ...
 * والمعلومات..) ويفكّ ترميز يونيكود (u متبوعًا برقم) وكذلك هروب hh السداسي
 * بشكل صحيح، وينتج فقرات نظيفة تُعرض بنفس مُحوّل عرض ملفات Word.
 */
                    ...
                    switch (word) {
                        ...
                        case "u":
                            if (num != null) {
                                ...
                                // تجاوز أحرف الاستبدال الاحتياطية بعد رمز u
                                int skipped = 0;
